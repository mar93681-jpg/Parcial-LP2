...
1. [Base de Estadísticas (EstadisticaBase.py)](EstadisticaBase.py)
2. [Inicializador (__init__.py)](__init__.py)
3. [Estadística Avanzada (estadistica_avanzada.py)](estadistica_avanzada.py)
4. [Estadística Cualitativa (estadistica_cualitativa.py)](estadistica_cualitativa.py)
5. [Estadística Cuantitativa (estadistica_cuantitativa.py)](estadistica_cuantitativa.py)
6. [Módulo Principal (main.py)](main.py)
7. [Simulador de Datos (simular_datos.py)](simular_datos.py)
